      ...
      <div class="sidebar-content">
        <div class="aside-toolbar">
          <ul class="site-logo">
            ...
            <!-- START LOGO -->
              <a href="">
                <div class="logo">
                  <svg id="logo" width="35" height="35" viewBox="0 0 54.03 56.55">
                    <defs>
        ...
        <nav class="main-menu">
          <ul class="nav metismenu">
            <li><a href="/dashboard"><i class="icon dripicons-meter"></i><span>Dashboard</span></a></li><br>
            <li><a href="{{route('pembelian.index')}}"><i class="icon dripicons-to-do"></i><span>Pembelian</span></a></li>
            <li><a href="{{route('barangmasuk.index')}}"><i class="icon dripicons-to-do"></i><span>Barang Masuk</span></a></li>
            <li><a href="{{route('barang.index')}}"><i class="icon dripicons-to-do"></i><span> Stock Barang</span></a></li>
